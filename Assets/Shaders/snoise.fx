// copied from https://github.com/keijiro/Museum/blob/master/Assets/Common/Shaders/SimplexNoise2D.hlsl
// which itself is modification of https://github.com/ashima/webgl-noise/blob/master/src/noise2D.glsl
// 
//
